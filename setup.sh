...
rm -rfv $prefix/drive_c/$photoshop/App/Ps/Required/CEP/CEPHtmlEngine/
rm -rfv $prefix/drive_c/$photoshop/App/Ps/Required/CEP/extensions/
...
echo '#!/bin/sh\nWINEPREFIX='$prefix' wine "C:\'$photoshop'\App\Ps\Photoshop.exe"' | sudo tee /usr/bin/photoshop.sh && sudo chmod +x /usr/bin/photoshop.sh
